...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuNoticeEdit.css">
...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<form id="uploadBoard" method="post" enctype="multipart/form-data">
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									...
									<a
										href="${pageContext.request.contextPath}/customerCenter/cuNoticeDetail/${cuNoticeVo.bor_num}"
							...
							<div class="box-body pad">
								<div class="form-group">
									<label for="exampleInputEmail1">Title</label> <input
										...
										value="${cuNoticeVo.bor_title}"> <input type="hidden"
										id="bor_num" name="bor_num" value="${cuNoticeVo.bor_num}">
									<fieldset>
										<input type="file" id="uploadFiles" multiple><br>
										<br>
									</fieldset>
								</div>
								<textarea id="bor_cont" name="bor_cont" rows="10" cols="80">${cuNoticeVo.bor_cont}</textarea>
							</div>
					<!-- /.수정div -->
						</form>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/customerCenter/cuNoticeEdit",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
				...
				success : function(res) {
					location.href="${pageContext.request.contextPath}/returnNotice";
				} 
			})
		});
