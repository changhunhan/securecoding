...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/css/cuNoticeDetail.css">
<head>
<meta charset="utf-8">
				...
				<div class="box-body">
					...
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<c:set value="${noticeVo.bor_wri_pers}" var="writer" />

							<c:if test="${id eq 'admin'}">
								<a href="${pageContext.request.contextPath}/customerCenter/cuNoticeEdit/${noticeVo.bor_num}"
									class="btn btn-info pull-right">수정</a>
								<a href="${pageContext.request.contextPath}/customerCenter/cuNoticeDelete/${noticeVo.bor_num}"
									class="btn btn-info pull-right">삭제</a>
								<a href="${pageContext.request.contextPath}/customerCenter/cuNoticeForm"
								class="btn btn-info pull-right">새글작성</a> 
							</c:if>
							
							<a href="${pageContext.request.contextPath}/returnNotice"
					...
					<div class="box-body no-padding">
						<div class="mailbox-read-info">
							<h3>${noticeVo.bor_title}
								<span class="mailbox-read-time pull-right">${noticeVo.bor_chk_con}</span>
							</h3>
							<h5>
								From: ${noticeVo.bor_wri_pers} <span
									class="mailbox-read-time pull-right">${noticeVo.bor_date}</span>
							</h5>
						</div>
										...
										<li><span class="mailbox-attachment-icon"> <i
											...
											<div class="mailbox-attachment-info">
												...
												<a href="${down}" class="mailbox-attachment-name">
													...
													class="mailbox-attachment-size"> ${vo.bor_file_size}
												</span>
												</a>
