...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuTnoticeDetail.css">
			...
			<div class="box-body">
				...
				<section class="col-lg-10"> 
						<div class="box-header with-border">
							...
							<c:set value="${tnoticeVo.bor_wri_pers}" var="writer"/>
							
							 <c:if test="${id eq writer || id eq 'admin'}">
								<a href="${pageContext.request.contextPath}/customerCenter/cuTnoticeEdit/${tnoticeVo.bor_num}"
									class="btn btn-info pull-right">수정</a> 
								<a href="${pageContext.request.contextPath}/customerCenter/cuTnoticeDelete/${tnoticeVo.bor_num}"
								...
								<a href="${pageContext.request.contextPath}/returntNotice"
						...
						<div class="box-body no-padding">
							<div class="mailbox-read-info">
								<h3>${tnoticeVo.bor_title}
									<span class="mailbox-read-time pull-right">${tnoticeVo.bor_chk_con}</span>
								</h3>
								<h5>
									From: ${tnoticeVo.bor_wri_pers} <span
										class="mailbox-read-time pull-right">${tnoticeVo.bor_date}</span>
								</h5>
							</div>
							...
							<!-- /.mailbox-controls -->
							<div class="mailbox-read-message">${tnoticeVo.bor_cont}</div>
															...
															<div class="user-block">
																<img class="img-circle img-bordered-sm"
																	...
																	<button type="button" id="deleteComment"
																		class="pull-right btn-box-tool" style="border: 0">
