...
<head>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuTnoticeForm.css">
</head>
<body>
	<div class="wrapper">
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/customerCenter/cuTnoticeForm",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
