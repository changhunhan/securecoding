...
<head>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuInquireBoard.css">
</head>
						...
						<div class="tab-content no-padding">
							<div class="chart tab-pane active" id="notice" style="position: relative;">
										...
										<tr>
											...
											<td class="mailbox-subject">
												...
												<img alt="" src="${pageContext.request.contextPath}/image/replyArrow.jpg">
													<a href="${pageContext.request.contextPath}/customerCenter/cuInquireReplyDetail/${vo.ans_bor_num}">
													${vo.ans_bor_title}
											...
											<c:if test="${vo.ans_bor_next_num eq '0'}">
														<a href="${pageContext.request.contextPath}/customerCenter/cuInquireDetail/${vo.ans_bor_num}">
														${vo.ans_bor_title}
														<c:if test="${vo.checkFile eq 'y'}">
														&nbsp&nbsp
														<i class="fa fa-fw fa-download"></i>
								...
								<div class="box-footer clearfix no-border">
									<a 
										href="${pageContext.request.contextPath}/customerCenter/cuInquireForm" 
