...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuInquireDetail.css">
</head>
				...
				<section class="col-lg-10"> 
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<c:if test="${mem_id eq inquireVo.ans_bor_wri_pers || id eq 'admin'}">				
								<a href="${pageContext.request.contextPath}/customerCenter/cuInquireDelete/${inquireVo.ans_bor_num}" class="btn btn-info pull-right">삭제</a>
								<a href="${pageContext.request.contextPath}/customerCenter/cuInquireEdit/${inquireVo.ans_bor_num}" class="btn btn-info pull-right">수정</a>
								<a href="${pageContext.request.contextPath}/customerCenter/cuInquireForm" class="btn btn-info pull-right" id="insert">새글작성</a>
							</c:if>	
						</div>
					</div>
					<div class="box-body no-padding">
						<div class="mailbox-read-info">
						 <input type="hidden" id="ans_bor_wri_pers" value="${mem_id}">
						  <input type="hidden" id="ans_bor_wri_pers1" value="${inquireVo.ans_bor_wri_pers}">
