...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuAdminInquireDetail.css">
</head>
				...
				<section class="col-lg-10"> 
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<a href="${pageContext.request.contextPath}/customerCenter/cuAdminInquireDelete/${ainquireVo.ans_bor_num}" class="btn btn-info pull-right">삭제</a>						
