...
<head>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuAdminInquireReplyForm.css">
...
<body>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/customerCenter/cuAdminInquireReply",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
