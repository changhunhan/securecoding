...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuAdminInquireReplyEdit.css">
...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<form id="uploadBoard" method="post" enctype="multipart/form-data">
						<div class="box-header">
							...
							<div class="box-tools pull-right">
								<a href="${pageContext.request.contextPath}/customerCenter/cuAdminInquireDetail/${cuaInquireVo.ans_bor_num}" class="btn btn-info pull-right">취소</a>
						...
						<div class="box-body pad">
							<div class="form-group">
								<label for="exampleInputEmail1">Title</label> <input
									...
									value="${cuaInquireVo.ans_bor_title}">
									<input type="hidden" id="ans_bor_num" name="ans_bor_num" value="${cuaInquireVo.ans_bor_num}">
								<fieldset>
									<input type="file" id="uploadFiles" multiple><br>
									<br>
								</fieldset>
							</div>
							<textarea id="ans_bor_cont" name="ans_bor_cont" rows="10" cols="80">${cuaInquireVo.ans_bor_cont}</textarea>
						</div>
					</form>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/customerCenter/cuAdminInquireReplyEdit",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
				...
				success : function(res) {
					location.href="${pageContext.request.contextPath}/adminInquire";
				} 
			})
		});
