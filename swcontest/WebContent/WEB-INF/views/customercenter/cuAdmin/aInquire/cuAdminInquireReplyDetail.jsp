...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cuAdminInquireReplyDetail.css">
</head>
				...
				<section class="col-lg-10"> 
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							<a href="${pageContext.request.contextPath}/customerCenter/cuAdminInquireReply/${ainquireVo.ans_bor_gup_num}/${ainquireVo.ans_bor_ori_num}/${ainquireVo.ans_bor_next_num}" class="btn btn-info pull-right">답글</a>
							<a href="${pageContext.request.contextPath}/customerCenter/cuAdminInquireReplyEdit/${ainquireVo.ans_bor_num}" class="btn btn-info pull-right">수정</a>
							<a href="${pageContext.request.contextPath}/customerCenter/cuInquireNumDelete/${ainquireVo.ans_bor_num}" class="btn btn-info pull-right">삭제</a>						
							<a href="${pageContext.request.contextPath}/adminInquire" class="btn btn-info pull-right">목록으로</a>
						</div>
					</div>
					<div class="box-body no-padding">
						<div class="mailbox-read-info">
							<h3>${ainquireVo.ans_bor_title}
								<span class="mailbox-read-time pull-right">${ainquireVo.ans_bor_chk_con}</span>
							</h3>
							<h5>
								From: ${ainquireVo.ans_bor_wri_pers} <span
									class="mailbox-read-time pull-right">${ainquireVo.ans_bor_date}</span>
							</h5>
						</div>
						...
						<!-- /.mailbox-controls -->
						<div class="mailbox-read-message">${ainquireVo.ans_bor_cont}</div>
