...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/aNoticeForm.css">
...
<body>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/aNotice/aNoticeForm",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
