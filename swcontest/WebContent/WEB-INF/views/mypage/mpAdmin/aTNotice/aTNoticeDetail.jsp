...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/aTNoticeDetail.css">
		...
		<section class="content">
			...
			<div class="box-body">
				...
				<section class="col-lg-10"> 
						...
						<a href="${pageContext.request.contextPath}/aTNotice/aTnoticeDelete/${aTnoticeVo.bor_num}"
									class="btn btn-info pull-right">삭제</a> <a
									href="${pageContext.request.contextPath}/aTNotice/aTNoticeMain"
						...
						<div class="box-body no-padding">
							<div class="mailbox-read-info">
								<h3>${aTnoticeVo.bor_title}
									<span class="mailbox-read-time pull-right">${aTnoticeVo.bor_chk_con}</span>
								</h3>
								<h5>
									From: ${aTnoticeVo.bor_wri_pers} <span
										class="mailbox-read-time pull-right">${aTnoticeVo.bor_date}</span>
								</h5>
							</div>
							...
							<!-- /.mailbox-controls -->
							<div class="mailbox-read-message">${aTnoticeVo.bor_cont}</div>
	...
	<!-- /. wrapper -->
		...
		<script type="text/javascript">
			function commentDelete() {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/commentTnoticeDeleteAjaxs/"
									+ comm_num + "&${bor_num}",
							type : "post",
							data : {
								"bor_num" : $("#bor_num").val(),
			...
			function commentInsert() {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/commentTnoticeInsertAjaxs/${bor_num}&"
									+ comm_title,
							type : "POST",
							data : {
								"bor_num" : $("#bor_num").val(),
