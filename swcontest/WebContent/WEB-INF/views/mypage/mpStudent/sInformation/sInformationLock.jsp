...
<script>
	function checkPassword() {
		...
		var pass = $("#password").val();
		  $.ajax({
			  url:'${pageContext.request.contextPath}/sInformation/checkPassword',
			  type:'post',
			  data: {'mem_id' : id},
	...
	<div class="box-body" id="boxStyle">
		<!-- Automatic element centering -->
			...
			<div class="lockscreen-item" >
				...
				<form class="lockscreen-credentials" id="lockSubmit" action="${pageContext.request.contextPath}/sInformation/studentMyInfoUpdate">
