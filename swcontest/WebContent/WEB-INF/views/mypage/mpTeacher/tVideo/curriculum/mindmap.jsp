...
<html>
<head>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/mindmap.css">
...
<script>
	...
	function mindmapCont(e,obj){
		...
		$.ajax({
	    	...
	    	success : function(res) {
	    		...
	    		/* var dmin=document.getElementById("mindmap_cont").value;
	    		alert("왜 안되니"+dmin);
	    		  if(dmin!=null){
	...
	function save() {
	    ...
	    formData2.append("mind_num",mind_num);
	    formData2.append("path",path.src);
	...
	function load() {
		...
		image.src=img.src;
		document.getElementById("ff").appendChild(image);
	}		
	...
	<div class="wrapper">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				<div class="box box-primary" style="padding: 1%; padding-bottom: 2%;">
					<br>
					...
					<textarea id="mySavedModel" style="width: 100%; height: 400px" hidden>{"class": "go.TreeModel","nodeDataArray":[{"key":0,"number":0, "text":"마인드맵","type":"boss" ,"loc":"0 0"}]}</textarea>
					<input type="text" id="key" name="key" value="${mind.key}" hidden> 
					<center><input type="text" id="mind_num" name="mind_num" value="${mind.mind_num}" style="width: 200px; text-align: center;"></center>
					
					
					<a href="#" data-toggle="modal" data-target="#signUpModal" id="searchModalStart"></a>
					
					<a href="#" data-toggle="modal" data-target="#contentModal" id="searchModalContent"></a>
					...
					<div class="modal fade" id="contentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content modal-popup">
								<%@include
									file="/WEB-INF/views/mypage/mpTeacher/tVideo/curriculum/mindmapForm.jsp"%>
							</div>
						</div>
					</div>
