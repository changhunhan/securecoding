			...
			<div class="col-md-3">
				...
				<div class="box box-primary">
					<div class="box-body box-profile">
						...
						<p class="text-muted text-center">${memberVo.mem_cla_cfy}</p>
				...
				<div class="box box-primary">
					...
					<form action="#" method="post">
						...
						<div class="form-group has-feedback"
							...
							<label for="id">이름</label> <input type="text" name="mem_name"
						...
						<div class="row">
							<div class="col-xs-4" style="margin-left: 10px">
								<label for="id">주민번호</label> <input type="text"
									name="mem_reg_num1" class="form-control input-sm"
									placeholder="Registration">
							</div>
							<div class="col-xs-4" style="margin-top: 20px">
								<label for="id"></label> <input type="password"
									name='mem_reg_num2' class="form-control input-sm"
									placeholder="Number">
							</div>
						</div>
						<div class="form-group has-feedback" style="margin: 10px">
						...
						<div class="form-group has-feedback" style="margin: 10px">
							<label for="id">전화번호</label> <input type="text" name="mem_tel"
								class="form-control input-sm" placeholder="Telephone number">
							<span class="glyphicon glyphicon-earphone form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback" style="margin: 10px">
							<label for="id">우편번호</label> <input type="text" name="mem_zip"
						...
						<div class="form-group has-feedback"
							style="margin: 10px; margin-top: 0px;">
							<label for="id">이메일</label> <input type="text" name="mem_email"
