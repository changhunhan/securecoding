...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/studyDetail.css">
			...
			<div class="box-body">
				...
				<section class="col-lg-10"> 
						<div class="box-header with-border">
							...
							<c:set value="${studyVo.bor_wri_pers}" var="writer"/>
							
							 <c:if test="${id eq writer || id eq 'admin'}">

								<a href="${pageContext.request.contextPath}/community/studyEdit/${studyVo.bor_num}"
									class="btn btn-info pull-right">수정</a> 
								<a href="${pageContext.request.contextPath}/community/studyDelete/${studyVo.bor_num}"
									class="btn btn-info pull-right">삭제</a> 
							</c:if>
								<a href="${pageContext.request.contextPath}/community/studyForm"
									class="btn btn-info pull-right">새글작성</a> 
								<a href="${pageContext.request.contextPath}/returnStudy"
						...
						<div class="box-body no-padding">
							<div class="mailbox-read-info">
								<h3>${studyVo.bor_title}
									<span class="mailbox-read-time pull-right">${studyVo.bor_chk_con}</span>
								</h3>
								<h5>
									From: ${studyVo.bor_wri_pers} <span
										class="mailbox-read-time pull-right">${studyVo.bor_date}</span>
								</h5>
							</div>
							...
							<!-- /.mailbox-controls -->
							<div class="mailbox-read-message">${studyVo.bor_cont}</div>
