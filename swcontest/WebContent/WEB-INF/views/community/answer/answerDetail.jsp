...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/answerDetail.css">
			...
			<div class="box-body">
				...
				<section class="col-lg-10"> 
						<div class="box-header with-border">
							...
							<c:set value="${answerVo.bor_wri_pers}" var="writer"/>
							
							 <c:if test="${id eq writer || id eq 'admin'}">
								<a href="${pageContext.request.contextPath}/community/answerEdit/${answerVo.bor_num}"
									class="btn btn-info pull-right">수정</a> 
								<a href="${pageContext.request.contextPath}/community/answerDelete/${answerVo.bor_num}"
								...
								<a href="${pageContext.request.contextPath}/community/answerBoard"
						...
						<div class="box-body no-padding">
							<div class="mailbox-read-info">
								<h3>${answerVo.bor_title}
									<span class="mailbox-read-time pull-right">${answerVo.bor_chk_con}</span>
								</h3>
								<h5>
									From: ${answerVo.bor_wri_pers} <span
										class="mailbox-read-time pull-right">${answerVo.bor_date}</span>
								</h5>
							</div>
							<!-- /.mailbox-read-info -->
							<div class="mailbox-read-message">${answerVo.bor_cont}</div>
