...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/answerForm.css">
...
                                        <option>컴퓨터응용가공산업기사</option>
									...
									<select class="form-control" name="count">
										...
										<input type="text" class="form-control" id="bor_title"
										placeholder="Title">
									<fieldset>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/community/answerForm",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
