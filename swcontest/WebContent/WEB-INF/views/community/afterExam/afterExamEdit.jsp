...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/afterExamEdit.css">
...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<form id="uploadBoard" method="post" enctype="multipart/form-data">
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									...
									<a
										href="${pageContext.request.contextPath}/community/afterExamDetail/${examVo.bor_num}"
							...
							<div class="box-body pad">
								<div class="form-group">
									<label for="exampleInputEmail1">Title</label> <input
										...
										value="${examVo.bor_title}"> <input type="hidden"
										id="bor_num" name="bor_num" value="${examVo.bor_num}">
									<fieldset>
										<input type="file" id="uploadFiles" multiple><br>
										<br>
									</fieldset>
								</div>
								<textarea id="bor_cont" name="bor_cont" rows="10" cols="80">${examVo.bor_cont}</textarea>
							</div>
							<!-- /.수정div -->
						</form>
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/community/afterExamEdit",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
