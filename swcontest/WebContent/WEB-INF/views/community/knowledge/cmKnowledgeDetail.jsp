			...
			<div class="box-body">
				...
				<section class="col-lg-10"> 
					...
					<c:if test="${id eq writer || id eq 'admin'}">
						<a href="${pageContext.request.contextPath}/community/cmKnowledgeDelete/${knowledgeVo.ans_bor_num}" class="btn btn-info pull-right">삭제</a>
						...
						<a href="${pageContext.request.contextPath}/community/cmKnowledgeForm" class="btn btn-info pull-right">새글작성</a>
					</c:if>	
