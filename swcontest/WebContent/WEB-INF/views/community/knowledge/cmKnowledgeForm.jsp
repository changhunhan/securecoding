...
<head>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/cmKnowledgeForm.css">
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script>
		...
		$("#uploadBoardClick").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/community/cmKnowledgeForm",
				type: "POST",
				data : formData,
				async: false,
				cache: false,
