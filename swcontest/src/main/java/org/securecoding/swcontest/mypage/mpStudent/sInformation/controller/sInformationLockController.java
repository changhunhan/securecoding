...
@Controller
public class sInformationLockController {
	...
	@RequestMapping("/sInformation/sInformationLock")
	...
	@RequestMapping(value="/sInformation/checkPassword", method=RequestMethod.POST)
	public @ResponseBody String lockProcess(@RequestParam String mem_id) {
		MemberVo pass = service.selectAllById(mem_id);
		return pass.getMem_pass();
	}
	
	@RequestMapping("/sInformation/studentMyInfoUpdate")
	public String form(Model model) {
		List<BannerVo> list = dday.getDDay();
		model.addAttribute("bannerVoList", list);

		return "redirect:/sInformation/sInformationMain";
	}
