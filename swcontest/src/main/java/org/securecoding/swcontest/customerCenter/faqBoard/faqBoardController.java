package org.securecoding.swcontest.customerCenter.faqBoard;
...
public class faqBoardController {
	...
	@RequestMapping(value="/returnFAQ", method=RequestMethod.GET)
	public String returnFAQPage(HttpSession session, Model model){
